    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Menu',
                    'url'  => 'admin/accueil#menu',
                ],
                [
                    'text' => 'Bannière',
                    'url'  => 'admin/accueil#banniere',
                ],
                [
                    'text' => 'Présentation',
                    'url'  => 'admin/accueil#presentation',
                ],
                [
                    'text' => 'Vidéo',
                    'url'  => 'admin/accueil#video',
                ],
                [
                    'text' => 'Testimonials',
                    'url'  => 'admin/accueil#testimonials',
                ],
                [
                    'text' => 'Team',
                    'url'  => 'admin/accueil#team',
                ],
                [
                    'text' => 'Ready',
                    'url'  => 'admin/accueil#ready',
                ],
                [
                    'text' => 'Contact',
                    'url'  => 'admin/accueil#contact',
                ],
            ],
        ],
