...
{{-- 
	<form action="blog/{{$article->id}}" method="get">
		@csrf --}}
					...
					<div class="col-md-8 col-sm-7 blog-posts">
						...
						<div class="single-post">
							<div class="post-thumbnail">
								...
								<div class="post-date">
									<h2>{{$article->jour}}</h2>
									<h3>{{$article->mois}} {{$article->annee}}</h3>
								</div>
							</div>
							...
							<div class="author">
								<div class="avatar">
									<img src="{{$article->imgurlauteur}}" alt="">
								</div>
								<div class="author-info">
									<h2>{{$article->auteur}}, <span>{{$article->fonction}}</span></h2>
